...
namespace StudentAccommodatioProgram
{
    public partial class frmLogin : Form
    {
       ...
       public  string UserName { get; set; }
        ...
        {
            string connectionString = @"Data Source=.;Initial Catalog=dbcampusCasa;Integrated Security=True"; // Replace with your actual connection string
            UserName = txtID.Text;
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                string selectQuery = $"SELECT courseName, companyName FROM UserTable WHERE password = @Password";
