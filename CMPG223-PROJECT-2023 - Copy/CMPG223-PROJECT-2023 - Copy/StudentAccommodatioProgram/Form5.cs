...
namespace StudentAccommodatioProgram
{
    public partial class frmAccommodation : Form
    {
        ...
        {
            txtDisplay.Clear();
            selectedAccommodationName = "Away Home";
        ...
        private void rdLofts_CheckedChanged(object sender, EventArgs e)
        {
            ...
            selectedAccommodationName = "StudySafe Lofts";
        ...
        private void rdHouse_CheckedChanged(object sender, EventArgs e)
        {
            ...
            selectedAccommodationName = "Student Living House";
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                connection.Open();
        ...
        {
            txtDisplay.Clear();
            selectedAccommodationName = "Campus Flats";
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                connection.Open();
        ...
        {
            txtDisplay.Clear();
            selectedAccommodationName = "StayHome Apartments";
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                connection.Open();
