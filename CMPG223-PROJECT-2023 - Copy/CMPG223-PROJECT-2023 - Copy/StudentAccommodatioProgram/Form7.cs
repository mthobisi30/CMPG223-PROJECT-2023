...
namespace StudentAccommodatioProgram
{
    public partial class frmLease : Form
    {
       ...
       "- All disputes will be settled according to local laws.\n";
        ...
        {
            using (SqlConnection connection = new SqlConnection(@"Data Source=.;Initial Catalog=dbcampusCasa;Integrated Security=True"))
            {
                connection.Open();
        ...
        private void InsertLeaseAgreement(DateTime startDate, DateTime endDate)
        {
            ...
            SqlConnection connection = new SqlConnection(@"Data Source=.;Initial Catalog=dbcampusCasa;Integrated Security=True");
            connection.Open();
